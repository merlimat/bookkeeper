...
public class InfoCommand extends BookieCommand<CliFlags> {
    ...
    public boolean apply(ServerConfiguration conf, CliFlags cmdFlags) {
        ...
        try (BookKeeper bk = new BookKeeper(clientConf)) {
            ...
            log.info().attr("t", totalFree + getReadable(totalFree)).log("Total free disk space in the cluster:\t");
            log.info().attr("t", total + getReadable(total)).log("Total disk capacity in the cluster:\t");
            bk.close();
