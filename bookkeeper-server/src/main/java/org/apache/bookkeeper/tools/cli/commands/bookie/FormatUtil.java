...
public class FormatUtil {
    ...
    public static void formatEntry(long pos, ByteBuf recBuff, boolean printMsg, LedgerIdFormatter ledgerIdFormatter,
        ...
        log.info("Type:           DATA");
        log.info().attr("lastAddConfirmed", lastAddConfirmed).log("LastConfirmed");
        if (!printMsg) {
            log.info("");
            return;
        }
