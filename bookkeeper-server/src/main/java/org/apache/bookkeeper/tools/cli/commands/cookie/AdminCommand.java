        ...
        return runFunctionWithRegistrationManager(bkConf, rm -> {
            try {
                ...
                try {
                    ...
                    log.error()
                            .attr("useHostname", useHostname)
                            .exception(nne)
                            .log("Either cookie already updated with UseHostNameAsBookieID= or no cookie exists!");
                    return false;
                }
                    ...
                    for (File verFile : allVersionFiles) {
                        if (!verFile.delete()) {
                            log.error()
                                    ...
                                    .log("Failed to delete Local cookie file . So aborting deletecookie of Bookie");
                            return false;
                        }
                    }
