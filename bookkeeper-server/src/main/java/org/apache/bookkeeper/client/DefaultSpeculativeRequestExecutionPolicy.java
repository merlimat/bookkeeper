                    ...
                    Futures.addCallback(issueNextRequest, new FutureCallback<Boolean>() {
                        ...
                        public void onSuccess(Boolean issueNextRequest) {
                            if (issueNextRequest) {
                                ...
                                .log("Stopped issuing speculative requests for , "
 + "speculativeReadTimeout = ");
                        ...
                        public void onFailure(Throwable thrown) {
                            log.warn()
                                    ...
                                    .attr("speculativeRequestTimeout", speculativeRequestTimeout)
                                    .attr("thrown", thrown)
                                    .log("Failed to issue speculative request for , speculativeReadTimeout = :");
                        }
                    }, directExecutor());
                }
            ...
            if (!scheduler.isShutdown()) {
                log.warn()
                        ...
                        .attr("requestExecutor", requestExecutor)
                        .attr("speculativeRequestTimeout", speculativeRequestTimeout)
                        .log("Failed to schedule speculative request for , speculativeReadTimeout = :");
            }
        }
        return null;
    }
