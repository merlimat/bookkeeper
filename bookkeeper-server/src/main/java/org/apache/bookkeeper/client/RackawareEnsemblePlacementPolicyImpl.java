...
public class RackawareEnsemblePlacementPolicyImpl extends TopologyAwareEnsemblePlacementPolicy {
            ...
            try {
                ...
                if (!conf.getEnforceMinNumRacksPerWriteQuorum()) {
                    log.warn()
                            ...
                            .attr("getMessage", re.getMessage())
                            .log("Failed to initialize DNS Resolver , used default subnet resolver because");
    ...
    public PlacementResult<BookieId> replaceBookie(int ensembleSize, int writeQuorumSize, int ackQuorumSize,
        ...
        try {
            ...
            .log("Try to choose a new bookie to replace from ensemble , excluding .");
        ...
        try {
            ...
            if (!fallbackToRandom) {
                log.error()
                        ...
                        .log("Failed to choose a bookie from : "
 ...
 + "Nodes: enforceMinNumRacksPerWriteQuorum is enabled so giving up.");
            ...
            log.warn()
                    .attr("excludeBookies", excludeBookies)
                    .log("Failed to choose a bookie: excluded , fallback to choose bookie randomly from the cluster.");
    ...
    protected List<BookieNode> selectRandomInternal(List<BookieNode> bookiesToSelectFrom,
        ...
        log.warn()
                ...
                .log("Failed to find bookies : excludeBookies , allBookies .");
