...
public final class PageCacheUtil {
    ...
    static {
        ...
        try {
            ...
            log.warn().attr("message", e.getMessage()).log("Unable to initialize NativeIO for posix_fadvise");
    ...
    public static void bestEffortRemoveFromPageCache(int fd, long offset, long len) {
        ...
        try {
            ...
            log.warn().attr("message", e.getMessage()).log("Failed to perform posix_fadvise");
            fadvisePossible = false;
        }
    }
}
