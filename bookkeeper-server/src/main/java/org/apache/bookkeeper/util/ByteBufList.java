...
public class ByteBufList extends AbstractReferenceCounted {
     ...
     * <p>
     * The buffers b1 and b2 lifecycles are now managed by the ByteBufList: when the {@link ByteBufList} is deallocated,
     ...
     * <p>
     * The buffer b1 lifecycle is now managed by the ByteBufList: when the {@link ByteBufList} is deallocated, b1 will
     * be released as well.
     *
     * @param b1
     *            first buffer
